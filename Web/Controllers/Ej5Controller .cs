...
namespace Web.Controllers
{
    ...
    public class Ej5Controller : ControllerBase
    {
        ...
        public string Get([FromQuery] string day)
        {
            ...
            {
                response = "Expresion invalida---====09099_+++)][[][";
            }
...
//5) Pedir el nombre del día al usuario y decirle si es fin de semana o no.  En caso de error, indicarlo. Se debe poder ingresar, por ejemplo, “Lunes” / “LUNES” / “lunes” / “lUnes” /
